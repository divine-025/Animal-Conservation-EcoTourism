...
# Adjust skiprows after inspecting step 1 or 2
df = pd.read_csv("API_ST.INT.RCPT.XP.ZS_DS2_en_excel_v2_21162.csv", skiprows=3)
...
df_long.to_csv("tourism_receipts_long.csv", index=False)
